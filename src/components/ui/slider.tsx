...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className='block h-4 w-4 rounded-full border border-slate-200 border-slate-900/50 bg-white shadow-sm transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:border-slate-800 dark:border-slate-50/50 dark:bg-white dark:focus-visible:ring-slate-300' />
  </SliderPrimitive.Root>
))
