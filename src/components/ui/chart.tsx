...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<typeof RechartsPrimitive.Tooltip> &
    React.ComponentProps<'div'> & {
      ...
      nameKey?: string
      labelKey?: string
      onTooltipCategory: React.Dispatch<React.SetStateAction<string>>
    }
>(
  (
    {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-fit gap-1.5 rounded-lg border border-zinc-200 border-zinc-200/50 bg-white px-2.5 py-1.5 text-xs shadow-xl dark:border-zinc-800 dark:border-zinc-800/50 dark:bg-zinc-950',
          className
        )}
      >
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        'flex gap-x-1.5 flex-1 justify-between leading-none',
